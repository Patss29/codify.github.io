                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <h5 style="font-weight: bold;">Event 1: CSD Week</h5>
                                                    ...
                                                    <a href="student_event.php"><button type="button" class="btn submit text-white">Take Attendance</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <h5 style="font-weight: bold;">Event 2: Tj Monterde Concert</h5>
